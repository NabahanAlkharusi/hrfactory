...
{
    public class FunctionPracticesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.FunctionPractices.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            FunctionPractice functionPractice = db.FunctionPractices.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,PracticeTitle,PracticeTitleAr,FunctionId,Status")] FunctionPractice functionPractice)
        {
            if (Session["UserId"] == null) return Redirect(Url.Action("Index", "Login", new { Area = "Admin", r = Request.Url.ToString() }));
            if (ModelState.IsValid)
            {
                db.FunctionPractices.Add(functionPractice);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PracticeTitle,PracticeTitleAr,FunctionId,Status")] FunctionPractice functionPractice)
        {
            if (Session["UserId"] == null) return Redirect(Url.Action("Index", "Login", new { Area = "Admin", r = Request.Url.ToString() }));
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            if (Session["UserId"] == null) return Redirect(Url.Action("Index", "Login", new { Area = "Admin", r = Request.Url.ToString() }));
            FunctionPractice functionPractice = db.FunctionPractices.Find(id);
            db.FunctionPractices.Remove(functionPractice);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
        ...
        public ActionResult GetFunctionPractices()
        {
            ...
            var functionPractices = db.FunctionPractices.Where(x => x.FunctionId == FunctionID).ToList();
