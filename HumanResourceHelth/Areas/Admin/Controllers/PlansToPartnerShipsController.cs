...
{
    public class PlansToPartnerShipsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.partnerShipPlans.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            PartnerShipPlans plans = db.partnerShipPlans.Find(id);
            if (plans == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "Id,PlanTitle,Objective,Process,Participants,Report,DeliveryMode,Limitations,PlanTitleAr,ObjectiveAr,ProcessAr,ParticipantsAr,ReportAr,DeliveryModeAr,LimitationsAr,TamplatePath,Price,Status")] PartnerShipPlans plans)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "Id,PlanTitle,Objective,Process,Participants,Report,DeliveryMode,Limitations,PlanTitleAr,ObjectiveAr,ProcessAr,ParticipantsAr,ReportAr,DeliveryModeAr,LimitationsAr,TamplatePath,Price,Status")] PartnerShipPlans plans)
        {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            if (Session["UserId"] == null) return Redirect(Url.Action("Index", "Login", new { Area = "Admin", r = Request.Url.ToString() }));
            PartnerShipPlans plans = db.partnerShipPlans.Find(id);
            db.partnerShipPlans.Remove(plans);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
        ...
        public ActionResult getPlans()
        {
            ...
            var plansId = db.Partnerships.Where(x => x.PartnerID == partnerId).Select(x => x.PlanID).ToArray();
            var plans = db.partnerShipPlans.Where(a=>plansId.Contains(a.Id)).ToList();
