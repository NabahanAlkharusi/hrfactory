...
{
    public class HPartnersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.HPartners.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            HPartners partners = db.HPartners.Find(id);
            if (partners == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,PartnerName,PartnerNameAr,PartnerofficalEmail,PartnerofficalPhone,PartnerCountry,PartnerAddress,PartnerFocalPointName,PartnerFocalPointNameAr,PartnerFocalPointEmail,PartnerFocalPointPhone,PartnerSubDomain,status")] HPartners partners)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PartnerName,PartnerNameAr,PartnerofficalEmail,PartnerofficalPhone,PartnerCountry,PartnerAddress,PartnerFocalPointName,PartnerFocalPointNameAr,PartnerFocalPointEmail,PartnerFocalPointPhone,PartnerSubDomain,status")] HPartners partners)
        {
