...
namespace HumanResourceHelth.Web.Controllers
{
    public class SurveyController : Controller
    {
        ...
        public ActionResult Intro()
        {
            ...
            List<TermsConditions> terms = _uow.TermsConditionsRepo.Search(a => a.CountryId == UserCountryId && a.TermsConditionType == (int)TermsConditionType.HrCheckUp).ToList();
            terms = terms.Count == 0 ? _uow.TermsConditionsRepo.Search(a => a.CountryId == 158 && a.TermsConditionType == (int)TermsConditionType.HrCheckUp).ToList() : terms;
            TermsConditions conditions = terms.FirstOrDefault();
